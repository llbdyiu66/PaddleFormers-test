...
from paddleformers.datasets import ZeroPaddingMapDataset, load_dataset
...
def main():
    ...
    if len(sys.argv) >= 2 and sys.argv[1].endswith(".json"):
        ...
        model_args, data_args, training_args, kto_config = parser.parse_yaml_file_and_cmd_lines()
    else:
