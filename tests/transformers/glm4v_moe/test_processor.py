...
class Glm4vMoeProcessorTest(ProcessorTesterMixin, unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        processor = Glm4vProcessor.from_pretrained(
            cls.model_path, patch_size=4, max_pixels=56 * 56, min_pixels=28 * 28
        )
    ...
    def test_model_input_names(self):
        "No fps in default metadata, skip it"
        pass
    ...
    def test_save_load_pretrained_default(self):
        ...
        processor = Glm4vProcessor.from_pretrained(self.tmpdir)

        self.assertEqual(processor.tokenizer.get_vocab(), tokenizer.get_vocab())
        self.assertEqual(processor.image_processor.to_json_string(), image_processor.to_json_string())
        self.assertEqual(processor.tokenizer.__class__.__name__, "TokenizersBackend")
