...
class Ernie4_5_MoeModelTest(ModelTesterMixin, GenerationTesterMixin, unittest.TestCase):
    ...
    def test_ernie4_5_moe_lm_head_model(self):
        pass
        # config_and_inputs = self.model_tester.prepare_config_and_inputs()
        # self.model_tester.create_and_check_lm_head_model(*config_and_inputs)

    def test_ernie4_5_moe_gqa_model(self):
        pass
        # config_and_inputs = self.model_tester.prepare_config_and_inputs()
...
class Ernie4_5_MoeModelIntegrationTest(ModelTesterPretrainedMixin, unittest.TestCase):
    base_model_class = Ernie4_5_MoeModel

    @slow
    def test_inference_no_attention(self):
        model = Ernie4_5_MoeModel.from_pretrained("__internal_testing__/tiny-random-ernie4_5_moe")
        model.eval()
...
class Ernie4_5_MoeGenerationD2STest(GenerationD2STestMixin, unittest.TestCase):
    internal_testing_model = "__internal_testing__/micro-random-ernie4_5_moe"


# class Ernie4_5_MoeCompatibilityTest(unittest.TestCase):
#     test_model_id = "hf-internal-testing/tiny-random-Ernie4_5_MoeModel"
...
#         config = Ernie4_5_MoeConfig(hidden_size=16, num_hidden_layers=1, num_attention_heads=2)
#         model = Ernie4_5_MoeForCausalLM(config)
...
#         paddle_model = Ernie4_5_MoeModel.from_pretrained(self.torch_model_path, convert_from_torch=True)
#         paddle_model.eval()
...
#         torch_model = Ernie4_5_MoeModel.from_pretrained(self.torch_model_path)
#         torch_model.eval()
...
#             paddle_model = Ernie4_5_MoeModel.from_pretrained(tempdir, convert_from_torch=True)
#             paddle_model.eval()
#             paddle_logit = paddle_model(paddle.to_tensor(input_ids))[0]
...
#     @require_package("transformers", "torch")
#     def test_ernie4_5_moe_classes_from_local_dir(self, class_name, pytorch_class_name: str | None = None):
